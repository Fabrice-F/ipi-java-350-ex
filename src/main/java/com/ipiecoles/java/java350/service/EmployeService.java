...
public class EmployeService {
    ...
    public void calculPerformanceCommercial(String matricule, Long caTraite, Long objectifCa) throws EmployeException {
        ...
        //Cas 2 : Si le chiffre d'affaire est inférieur entre 20% et 5% par rapport à l'ojectif fixé, il perd 2 de performance (dans la limite de la performance de base)
        ...
        //Cas 4 : i le chiffre d'affaire est supérieur entre 5 et 20%, il gagne 1 de performance
